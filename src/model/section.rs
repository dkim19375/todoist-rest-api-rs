...
impl Section {
    ...
    pub async fn create_new_copy(self, config: &TodoistConfig) -> Result<Section, TodoistAPIError> {
    ...
    ///
    /// If the section no longer exists, then a [TodoistAPIError] will be returned.
    ///
    ...
    pub async fn update(self, config: &TodoistConfig) -> Result<Section, TodoistAPIError> {
